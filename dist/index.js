...
const fetch = __nccwpck_require__(218);
...
const core = __nccwpck_require__(12);
...
const utils_1 = __nccwpck_require__(62);
/**
 * Commands
 *
 * Command Format:
...
const file_command_1 = __nccwpck_require__(791);
const utils_1 = __nccwpck_require__(62);
const os = __importStar(__nccwpck_require__(37));
...
var iconvLite = __nccwpck_require__(323);
...
var Buffer = (__nccwpck_require__(978).Buffer);
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(965) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(750) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(904) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(904).concat)(__nccwpck_require__(429)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(904).concat)(__nccwpck_require__(429)) },
        gb18030: function() { return __nccwpck_require__(893) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(940) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(507) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(507).concat)(__nccwpck_require__(768)) },
...
var modules = [
    ...
    __nccwpck_require__(801),
    __nccwpck_require__(952),
    __nccwpck_require__(734),
    __nccwpck_require__(751),
    __nccwpck_require__(501),
    __nccwpck_require__(905),
...
var bomHandling = __nccwpck_require__(53),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(284); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __nccwpck_require__(787)(stream_module);
...
let convert;
try {
	convert = (__nccwpck_require__(366)/* .convert */ .O);
} catch (e) {}
